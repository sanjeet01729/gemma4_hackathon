...
import { askGemma } from "../api/gemma";
...
export default function ChatScreen({ navigation, route }: Props) {
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      const answer = await askGemma(trimmed, language, subjectId);
      setMessages((prev) => [
        ...prev,
        {
