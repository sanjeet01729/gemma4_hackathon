...
const DAILY_QUESTIONS = {
  hindi: [
    ...
    "पाटलिपुत्र किस नदी के किनारे बसा है?",
    "भारत का संविधान कब लागू हुआ?",
    "नालंदा विश्वविद्यालय किस राज्य में है?",
  ...
  english: [
    ...
    "On which river bank is Pataliputra situated?",
    "When did the Indian Constitution come into effect?",
    "In which state is Nalanda University located?",
    "Who was the first female Prime Minister of India?",
    "In which year did the Champaran Satyagraha happen?",
...
export default function HomeScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    ...
    const questions =
      language === "hindi" ? DAILY_QUESTIONS.hindi : DAILY_QUESTIONS.english;
  ...
  const handleSearchSubmit = () => {
    ...
    navigation.navigate("Chat", {
      subjectId: "free",
      subjectName:
        language === "hindi" ? "PadhAI असिस्टेंट" : "PadhAI Assistant",
    });
  };
        ...
        <Animated.View style={{ opacity: fadeAnim }}>
          ...
          <View style={styles.aiSearchBar}>
            ...
            <TouchableOpacity
              style={[
                styles.micBtn,
                searchInput.trim().length > 0 && styles.micBtnActive,
              ]}
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Practice", {
                subjectId: "gk",
                subjectName: language === "hindi" ? "अभ्यास करें" : "Practice",
              })
            }
          >
            <Text style={styles.practiceBtnIcon}>🎯</Text>
            <View>
              <Text style={styles.practiceBtnTitle}>
                {language === "hindi" ? "MCQ अभ्यास" : "MCQ Practice"}
              </Text>
              <Text style={styles.practiceBtnSub}>
                {language === "hindi"
                  ? "सरकारी परीक्षा के सवाल"
          ...
          <View style={styles.grid}>
            {SUBJECTS.map((sub) => (
              <TouchableOpacity
                ...
                style={[
                  styles.subCard,
                  sub.id === "free" && styles.subCardFull,
                ]}
...
const styles = StyleSheet.create({
  ...
  practiceBtnSub: { fontSize: 12, color: "#64748B" },
  practiceBtnArrow: {
    fontSize: 20,
    color: "#FFB800",
